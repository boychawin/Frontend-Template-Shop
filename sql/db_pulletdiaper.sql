...
--
-- Host: localhost
-- Generation Time: Aug 29, 2021 at 04:56 PM
...
CREATE TABLE `career` (
  ...
  `proviance` int(10) NOT NULL,
  `district` int(10) NOT NULL,
  `subdistrict` int(10) NOT NULL,
...
INSERT INTO `career` (`id`, `fname`, `lname`, `tal`, `email`, `address`, `proviance`, `district`, `subdistrict`, `postcode`, `business_type`, `specify`, `status`, `date_create`) VALUES
(1, 'boy', 'chawin', '0880344340', 'boychawin.com@gmail.com', 'boychawin.com', 3, 58, 120102, 11000, '0', 'ท่องเที่ยว', '1', '2021-08-07 17:59:03'),
(2, 'boy', 'chawin', '0880344340', 'boychawin.com@gmail.com', 'boychawin.com', 1, 2, 100201, 10300, 'โรงพยาบาล', '', '1', '2021-08-07 17:59:43');
...
CREATE TABLE `category` (
  ...
  `num_formula` int(11) DEFAULT NULL,
  `cat_slug` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `type` enum('0','1') CHARACTER SET utf8 NOT NULL DEFAULT '0' COMMENT '0=สินค้า,1=สาระ',
  `date_create` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `category` (`id`, `name`, `num_formula`, `cat_slug`, `type`, `date_create`) VALUES
(1, 'กางเกงรุ่นบาง', 3, NULL, '0', '2021-08-06 13:24:04'),
(2, 'กางเกงรุ่นบางและกางเกงรุ่นซึมซับมาก', 5, NULL, '0', '2021-08-06 13:24:20'),
(3, 'กางเกงรุ่นหนา', 7, NULL, '0', '2021-08-06 13:24:32'),
(4, 'เทปกาวรุ่นประหยัด', 9, NULL, '0', '2021-08-06 13:24:43'),
(5, 'เทปกาว', 11, NULL, '0', '2021-08-06 13:25:00'),
(6, 'กางเกงรุ่นซึมซับมากพิเศษ', 8, NULL, '0', '2021-08-06 13:27:35'),
(11, 'สาระน่ารู้', NULL, NULL, '1', '2021-08-06 16:40:58');
...
CREATE TABLE `products` (
  ...
  `type` enum('0','1') NOT NULL DEFAULT '0' COMMENT '0=สินค้า ,1= สาระ',
  `name` text NOT NULL,
  `description` text NOT NULL,
  `description2` text DEFAULT NULL COMMENT 'วิธีใช้',
  `description3` text DEFAULT NULL COMMENT 'วิธีสวมใส่',
  `description_feature_type` enum('0','1') NOT NULL DEFAULT '0',
  `description_feature_1` text DEFAULT NULL,
  `description_feature_2` text DEFAULT NULL,
  `description_feature_3` text DEFAULT NULL,
  `description_feature_4` text DEFAULT NULL,
  `description_feature_5` text DEFAULT NULL,
  `description_feature_6` text DEFAULT NULL,
  `size` varchar(100) DEFAULT NULL COMMENT 'ไซส์',
  `size_packing` varchar(100) DEFAULT NULL,
  `size_recommended` varchar(100) DEFAULT NULL,
  `slug` varchar(200) NOT NULL,
  `price` double DEFAULT NULL,
  `photo` varchar(200) DEFAULT NULL,
  `link_shop` varchar(100) DEFAULT NULL,
  `date_view` date DEFAULT NULL,
  `counter` int(11) DEFAULT NULL,
  `guide_status` int(11) DEFAULT NULL,
  `date_create` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `products` (`id`, `category_id`, `type`, `name`, `description`, `description2`, `description3`, `description_feature_type`, `description_feature_1`, `description_feature_2`, `description_feature_3`, `description_feature_4`, `description_feature_5`, `description_feature_6`, `size`, `size_packing`, `size_recommended`, `slug`, `price`, `photo`, `link_shop`, `date_view`, `counter`, `guide_status`, `date_create`) VALUES
(1, 5, '0', 'เทปกาว', '<p><span style=\"font-weight: normal;\"><br></span></p><p><br></p>', '<p><span style=\"font-weight: normal;\"><br></span></p><p><span style=\"font-weight: normal;\">ใช้สวมใส่ได้ทั้งผู้ชายและผู้หญิง </span></p><p><span style=\"font-weight: normal;\">เหมาะสำหรับ: ผู้ที่นอนติดเตียงหรือผู้ที่เคลื่อนไหวไม่สะดวก สวมใส่ได้ทั้งตอนกลางวันและตอนกลางคืน</span></p><p><span style=\"font-weight: normal;\"><br></span></p>', '<p><span style=\"font-weight: normal;\"><br></span></p><h5>ใส่ในท่ายืน</h5><h4><img src=\"https://i.imgur.com/TFogmBA.png\" style=\"width: 500px;\"><span style=\"font-weight: normal;\"><br></span></h4><p><span style=\"font-weight: normal;\">1. ดึงผ้าอ้อมส่วนหน้าขึ้น </span></p><p><span style=\"font-weight: normal;\">2. ติดเเถบเทปทั้ง2ข้างเข้าหากัน </span></p><p><span style=\"font-weight: normal;\"><br></span></p><h5>ใส่ในท่านอน</h5><p><img src=\"https://i.imgur.com/5fgmRmW.png\" style=\"width: 500px;\"><span style=\"font-weight: normal;\"><br></span></p><p><span style=\"font-weight: normal;\"> </span></p><p><span style=\"font-weight: normal;\">1. พลิกตัวตะแคงสอดผ้าอ้อมเข้าไประหว่างขาหนีบ </span></p><p><span style=\"font-weight: normal;\">2. พลิกตัวกลับเเละดึงผ้าอ้อมส่วนหน้าขึ้น </span></p><p><span style=\"font-weight: normal;\">3. ติดเเถบเทปทั้ง 2 ข้างเข้าหากัน</span></p><p><span style=\"font-weight: normal;\"><br></span></p>', '1', 'ซึมซับปัสสาวะมากถึง 800 ซีซี ด้วยเจลซึมซับมากจากประเทศญี่ปุ่น', 'เทปติดแน่น ติดได้หลายครั้ง', 'แอนตี้แบคทีเรีย ป้องกันการเจริญเติบโตของเชื้อแบคทีเรีย', 'แถบแสดงความเปียกชื้น (เมื่อผ้าอ้อมเปียกชื้นสีของแถบวัดจะจางหายไป บ่งบอกเวลาที่ควรเปลี่ยนผ้าอ้อมชิ้นใหม่)', 'ซึมซับเร็ว ไม่ไหลย้อนกลับ แห้งสนิท', 'ขอบขาตั้งทั้ง2ข้างป้องกันการรั่วซึม - เทปติดแน่น ติดได้หลายครั้ง', ' M , L ', '25 ชิ้น, 23 ชิ้น', '32 นิ้ว , 55 นิ้ว ', '', 0, '_1628355340.png', 'https://shopee.co.th/pullet_official_shop', NULL, NULL, NULL, '2021-08-06 13:38:53'),
(2, 4, '0', 'เทปกาวรุ่นประหยัด', '<p><br></p><p><br></p>', '<p><span style=\"font-weight: normal;\">ใช้สวมใส่ได้ทั้งผู้ชายและผู้หญิง </span></p><p><span style=\"font-weight: normal;\">เหมาะสำหรับ: ผู้ที่นอนติดเตียงหรือผู้ที่เคลื่อนไหวไม่สะดวก สวมใส่ได้ทั้งตอนกลางวันและตอนกลางคืน</span></p>', '<p><span style=\"font-weight: normal;\"><br></span></p><h5>ใส่ในท่ายืน</h5><p><img src=\"https://i.imgur.com/TFogmBA.png\" style=\"width: 500px;\"><br></p><p><span style=\"font-weight: normal;\">1. ดึงผ้าอ้อมส่วนหน้าขึ้น </span></p><p><span style=\"font-weight: normal;\">2. ติดเเถบเทปทั้ง 2 ข้างเข้าหากัน </span></p><p><span style=\"font-weight: normal;\"><br></span></p><h5>ใส่ในท่านอน</h5><p><img src=\"https://i.imgur.com/5fgmRmW.png\" style=\"width: 500px;\"><br></p><p><span style=\"font-weight: normal;\">1. พลิกตัวตะแคงสอดผ้าอ้อมเข้าไประหว่างขาหนีบ </span></p><p><span style=\"font-weight: normal;\">2. พลิกตัวกลับเเละดึงผ้าอ้อมส่วนหน้าขึ้น </span></p><p><span style=\"font-weight: normal;\">3. ติดเเถบเทปทั้ง2ข้างเข้าหากัน</span></p><p><span style=\"font-weight: normal;\"><br></span><br></p>', '1', 'ซึมซับปัสสาวะมากถึง 750 ซีซี ด้วยเจลซึมซับมากจากประเทศญี่ปุ่น', 'เทปติดแน่น ติดได้หลายครั้ง', 'แอนตี้แบคทีเรีย ป้องกันการเจริญเติบโตของเชื้อแบคทีเรีย', 'แถบแสดงความเปียกชื้น (เมื่อผ้าอ้อมเปียกชื้นสีของแถบวัดจะจางหายไป บ่งบอกเวลาที่ควรเปลี่ยนผ้าอ้อมชิ้นใหม่)', 'ซึมซับเร็ว ไม่ไหลย้อนกลับ แห้งสนิท', 'ขอบขาตั้งทั้ง2ข้างป้องกันการรั่วซึม - เทปติดแน่น ติดได้หลายครั้ง', ' M , L ', '14 ชิ้น, 12 ชิ้น', ' 32 นิ้ว, 50 นิ้ว', '', 0, '_1628355165.png', 'https://shopee.co.th/pullet_official_shop', NULL, NULL, NULL, '2021-08-06 15:52:26'),
(3, 1, '0', 'กางเกงรุ่นบาง', '<p><br></p><p><br></p>', '<p><span style=\"font-weight: normal;\"><br></span></p><p><span style=\"font-weight: normal;\">สามารถสวมใส่ได้ทั้งผู้ชายและผู้หญิง </span></p><p><span style=\"font-weight: normal;\">เหมาะสำหรับ: ผู้ที่เคลื่อนไหวได้และผู้ที่เคลื่อนไหวได้โดยมีผู้ช่วยเหลือ สวมใส่ได้ทั้งตอนกลางวันและตอนกลางคืน</span></p><p><span style=\"font-weight: normal;\"><br></span><br></p>', '<p><span style=\"font-weight: normal;\"><br></span></p><p><img src=\"https://i.imgur.com/TFogmBA.png\" style=\"width: 500px;\"><span style=\"font-weight: normal;\"><br></span></p><p><span style=\"font-weight: normal;\">1. ยืดขอบยางยืดรอบตัวสวมใส่แบบกางเกงใน </span></p><p><span style=\"font-weight: normal;\">วิธีทิ้งผ้าอ้อม: </span></p><p><span style=\"font-weight: normal;\">1. ฉีกตะเข็บผ้าอ้อมกางเกงทั้ง 2 ข้างออก</span><br></p>', '0', 'ซึมซับปัสสาวะมากถึง 800 ซีซี ด้วยเจลซึมซับมากจากประเทศญี่ปุ่น', 'ขอบขาตั้ง2ข้างป้องกันการรั่วซึม', 'ซึมซับเร็ว ไม่ไหลย้อนกลับ แห้งสนิท', 'ขอบเอวยางยืด กระชับ', 'ผิวสัมผัสนุ่ม บางสบาย', 'ระบายอากาศได้ดี ไม่อับชื้น', ' M , L , XL', '25 ชิ้น, 23 ชิ้น, 21 ชิ้น', '32 นิ้ว , 38 นิ้ว , 55 นิ้ว ', '', 0, '_1628355192.png', 'https://shopee.co.th/pullet_official_shop', NULL, NULL, NULL, '2021-08-06 16:05:21'),
(4, 6, '0', 'กางเกงรุ่นซึมซับมากพิเศษ', '<p>&nbsp;</p><p><br></p>', '<p><span style=\"font-weight: normal;\"><br></span></p><p><span style=\"font-weight: normal;\">สามารถสวมใส่ได้ทั้งผู้ชายและผู้หญิง </span></p><p><span style=\"font-weight: normal;\">เหมาะสำหรับ: ผู้ที่เคลื่อนไหวได้และผู้ที่เคลื่อนไหวได้โดยมีผู้ช่วยเหลือ สวมใส่ได้ทั้งตอนกลางวันและตอนกลางคืน</span></p><p><span style=\"font-weight: normal;\"><br></span><br></p>', '<p><img src=\"https://i.imgur.com/TFogmBA.png\" style=\"width: 500px;\"><span style=\"font-weight: normal;\"><br></span></p><p><span style=\"font-weight: normal;\">1. ยืดขอบยางยืดรอบตัวสวมใส่แบบกางเกงใน </span></p><p><span style=\"font-weight: normal;\">วิธีทิ้งผ้าอ้อม: </span></p><p><span style=\"font-weight: normal;\">1. ฉีกตะเข็บผ้าอ้อมกางเกงทั้ง 2 ข้างออก</span><br></p>', '0', 'ซึมซับปัสสาวะมากถึง 1000 ซีซี ด้วยเจลซึมซับมากจากประเทศญี่ปุ่น', 'ขอบขาตั้ง2ข้างป้องกันการรั่วซึม', 'ซึมซับเร็ว ไม่ไหลย้อนกลับ แห้งสนิท', 'ขอบเอวยางยืด กระชับ', 'ผิวสัมผัสนุ่ม บางสบาย', 'ระบายอากาศได้ดี ไม่อับชื้น', ' S ,M , L , XL', '26 ชิ้น, 24 ชิ้น, 22 ชิ้น, 20 ชิ้น', '26 นิ้ว ,32 นิ้ว , 38 นิ้ว , 55 นิ้ว ', '', 0, '_1628355201.png', 'https://shopee.co.th/pullet_official_shop', NULL, NULL, NULL, '2021-08-06 16:08:47'),
(5, 11, '1', '3 เคล็ดลับ เลือกผ้าอ้อมผู้ใหญ่ให้เหมาะสม', '<p style=\"box-sizing: inherit; font-family: Sarabun, serif; font-weight: 400;\"><span style=\"box-sizing: inherit; font-weight: bolder;\">1. ความสามารถในการเคลื่อนไหว หรือ Activities of Daily Living : ADL</span><br style=\"box-sizing: inherit;\">เหมาะกับผ้าอ้อมแบบกางเกง<br style=\"box-sizing: inherit;\">ADL 0 : ผู้ที่ใช้ชีวิตประจำวันได้ตามปกติ<br style=\"box-sizing: inherit;\">ADL 1 : ผู้สูงอายุที่เดินได้ด้วยตัวเอง<br style=\"box-sizing: inherit;\">ADL 2 : ผู้สูงอายุที่เดินได้ด้วยผู้ช่วยเหลือ<br style=\"box-sizing: inherit;\">ADL 3 : ผู้สูงอายุที่ยืนได้โดยผู้ช่วยเหลือ</p><p style=\"box-sizing: inherit; font-family: Sarabun, serif; font-weight: 400;\">เหมาะกับผ้าอ้อมแบบเทป<br style=\"box-sizing: inherit;\">ADL 4 : ผู้สูงอายุที่นั่งได้โดยผู้ช่วยเหลือ<br style=\"box-sizing: inherit;\">ADL 5 : ผู้สูงอายุที่นอนติดเตียง</p><p style=\"box-sizing: inherit; font-family: Sarabun, serif; font-weight: 400;\"><span style=\"box-sizing: inherit; font-weight: bolder;\">2. ปัญหาปัสสาวะ</span><br style=\"box-sizing: inherit;\">- กลั้นได้ เริ่มมีปัสสาวะเล็ด เมื่อไอ จาม หรือเมื่อก้มลงยกของหนักจากพื้น หรือออกกำลังกาย เช่น วิ่ง กระโดด หรือแม้แต่ก้าวขึ้นบันไดหลายๆ ขั้น<br style=\"box-sizing: inherit;\">- กลั้นได้บ้าง มีปัสสาวะไหลซึม โดยไม่มีความรู้สึกอยากปัสสาวะ หรือไหลล้นซึมเมื่อมีการปวดปัสสาวะ<br style=\"box-sizing: inherit;\">- ควบคุมหรือกลั้นปัสสาวะไม่ได้ ปัสสาวะไหลออกมาจนหมดในครั้งเดียว</p><p style=\"box-sizing: inherit; font-family: Sarabun, serif; font-weight: 400;\"><span style=\"box-sizing: inherit; font-weight: bolder;\">3. ระดับการซึมซับที่เหมาะกับอาการ</span><br style=\"box-sizing: inherit;\">- ระดับการซึมซับแบบเริ่มต้น (350cc) เน้นความบางสบาย คล้ายใส่กางเกงใน<br style=\"box-sizing: inherit;\">เหมาะสำหรับผู้ที่เริ่มต้นมีปัญหาปัสสาวะ มีปัสสาวะเล็ด เมื่อไอ จาม<br style=\"box-sizing: inherit;\">- ระดับการซึมซับแบบปกติ (450cc) เน้นความบางสบาย คล้ายใส่กางเกงใน<br style=\"box-sizing: inherit;\">เหมาะสำหรับผู้ที่มีปัสสาวะไหลซึม กลั้นปัสสาวะได้บ้าง<br style=\"box-sizing: inherit;\">- ระดับการซึมซับมาก (600cc)<br style=\"box-sizing: inherit;\">เหมาะสำหรับผู้ที่เคลื่อนไหวช้า เข้าห้องน้ำไม่ทัน<br style=\"box-sizing: inherit;\">- ระดับการซึมซับมากและยาวนาน (800cc)<br style=\"box-sizing: inherit;\">เหมาะสำหรับผู้ที่เคลื่อนไหวหรือเข้าห้องน้้ำไม่สะดวก กลั้นปัสสาวะไม่ได้<br style=\"box-sizing: inherit;\">- ระดับการซึมซับสูง<br style=\"box-sizing: inherit;\">เหมาะสำหรับผู้ที่นอนติดเตียง กลั้นปัสสาวะไม่ได้</p><p style=\"box-sizing: inherit; font-family: Sarabun, serif; font-weight: 400;\"><br></p>', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', 0, '0_1628268350.jpeg', NULL, NULL, NULL, NULL, '2021-08-06 16:42:24');
...
CREATE TABLE `users` (
  ...
  `type` enum('0','1') CHARACTER SET utf8 NOT NULL COMMENT '0=admin , 1=user',
  `firstname` varchar(50) CHARACTER SET utf8 NOT NULL,
  `lastname` varchar(50) CHARACTER SET utf8 NOT NULL,
  `address` text CHARACTER SET utf8 DEFAULT NULL,
  `contact_info` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `photo` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `status` enum('0','1') CHARACTER SET utf8 NOT NULL COMMENT '0=ไม่ใช้งาน,1=ใช้งาน',
  `activate_code` varchar(15) CHARACTER SET utf8 DEFAULT NULL,
  `reset_code` varchar(15) CHARACTER SET utf8 DEFAULT NULL,
...
(1, 'admin@admin.com', '$2y$10$0SHFfoWzz8WZpdu9Qw//E.tWamILbiNCX7bqhy3od0gvK5.kSJ8N2', '0', 'Code', 'Projects', '', '', 'thanos1.jpg', '1', '', '', '2018-04-30 17:00:00'),
(9, 'harry@den.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', '0', 'Harry', 'Den', 'Silay City, Negros Occidental', '09092735719', 'male2.png', '0', 'k8FBpynQfqsv', 'wzPGkX5IODlTYHg', '2018-05-08 17:00:00'),
(12, 'christine@gmail.com', '$2y$10$ozW4c8r313YiBsf7HD7m6egZwpvoE983IHfZsPRxrO1hWXfPRpxHO', '0', 'Christine', 'becker', 'demo', '7542214500', 'female3.jpg', '0', '', '', '2018-07-08 17:00:00');
